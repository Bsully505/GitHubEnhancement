...
public class HttpRequest {
    ...
    public static Response get(String endpoint, QueryParams queryParams, github.tools.client.BasicAuth basicAuth) {
        try {
            String queryString = "";
            if (queryParams != null) {
    ...
    public static Response post(String endpoint, RequestParams params, github.tools.client.BasicAuth basicAuth) {
        try {
    ...
    public static Response put(String endpoint, RequestParams params, github.tools.client.BasicAuth basicAuth) {
        try {
            URL url = new URL(endpoint);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public static Response patch(String endpoint, RequestParams params,github.tools.client.BasicAuth basicAuth) {
        try {
            URL url = new URL(endpoint);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public static Response delete(String endpoint, RequestParams params, github.tools.client.BasicAuth basicAuth) {
        try {
            URL url = new URL(endpoint);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
